...
window.addEventListener('load', () => {
    speak("Initializing Now Now Inc Bot ..");
    wishMe();
});
...
function takeCommand(message) {
    ...
    } else if (message.includes("what is your name") || message.includes("who are you") || message.includes("what's your name")) {
        speak("My name is Cody, I am AI Bot of Now Now.");
    } else if (message.includes("who is the founder of now now") || message.includes("what is the founder's name") || message.includes("who is founder of now now")) {
        speak("The founder of Now Now is Amrita Purohit.");
